    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-right">
                <h2>Edit Company Employee Profile</h2>
            </div>
            <div class="pull-right">
        ...
        <div class="row">
         ...
         <div class="row">
		    ...
		    <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>Email:</strong>
                    <input type="email" name="email"  id="email" class="form-control" value="{{ $employee->email }}" placeholder="Employee Email">
		        </div>
		    </div> 
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>Phone:</strong>
                    <input type="number" name="phone"  id="phone" class="form-control" value="{{ $employee->phone }}" placeholder="Enter Employee Number">
		        </div>
		    </div> 
